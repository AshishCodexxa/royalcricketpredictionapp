...
public class AdapterFantasyBowler extends RecyclerView.Adapter<AdapterFantasyBowler.ViewHolder> {
    Context context;
    String matchStatus;
    OnItemClickListener onItemClickListener;
    List<GetFantasySixTeamsQuery.Bowler> playerArrayList;

    public interface OnItemClickListener {
        void onItemClick(String str);
    }

    public AdapterFantasyBowler(Context context2, List<GetFantasySixTeamsQuery.Bowler> list, String str, OnItemClickListener onItemClickListener2) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AdapterFantasyBowler.this.onItemClickListener.onItemClick(AdapterFantasyBowler.this.playerArrayList.get(i).playerId());
            }
        });
    }
