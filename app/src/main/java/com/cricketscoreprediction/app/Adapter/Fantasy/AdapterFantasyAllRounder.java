...
public class AdapterFantasyAllRounder extends RecyclerView.Adapter<AdapterFantasyAllRounder.ViewHolder> {
    Context context;
    String matchStatus;
    OnItemClickListener onItemClickListener;
    List<GetFantasySixTeamsQuery.All_rounder> playerArrayList;

    public interface OnItemClickListener {
        void onItemClick(String str);
    }

    public AdapterFantasyAllRounder(Context context2, List<GetFantasySixTeamsQuery.All_rounder> list, String str, OnItemClickListener onItemClickListener2) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
        ...
        ((RequestBuilder) with.load(Glob.player_start + this.playerArrayList.get(i).playerId() + Glob.player_end).placeholder((int) R.drawable.player_dummy)).into(viewHolder.img_player);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AdapterFantasyAllRounder.this.onItemClickListener.onItemClick(AdapterFantasyAllRounder.this.playerArrayList.get(i).playerId());
            }
        });
    }
