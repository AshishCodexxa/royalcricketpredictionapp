...
public final class ItemAdSmallBinding implements ViewBinding {
    ...
    private ItemAdSmallBinding(CardView cardView2, ImageView imageView, ImageView imageView2, CardView cardView3, RelativeLayout relativeLayout) {
    ...
    public static ItemAdSmallBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        ...
        if (imageView != null) {
            ...
            if (imageView2 != null) {
                ...
                if (relativeLayout != null) {
                    return new ItemAdSmallBinding(cardView2, imageView, imageView2, cardView2, relativeLayout);
                }
            }
        }
