...
public final class AdFacebookNativeMediumBinding implements ViewBinding {
    ...
    private AdFacebookNativeMediumBinding(RelativeLayout relativeLayout, LinearLayout linearLayout, LinearLayout linearLayout2, TextView textView, Button button, MediaView mediaView, MediaView mediaView2, TextView textView2, TextView textView3, TextView textView4, RelativeLayout relativeLayout2) {
    ...
    public static AdFacebookNativeMediumBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AdFacebookNativeMediumBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ad_facebook_native_medium, viewGroup, false);
        if (z) {
    ...
    public static AdFacebookNativeMediumBinding bind(View view) {
                                    ...
                                    if (textView3 != null) {
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (relativeLayout != null) {
                                                return new AdFacebookNativeMediumBinding((RelativeLayout) view, linearLayout, linearLayout2, textView, button, mediaView, mediaView2, textView2, textView3, textView4, relativeLayout);
                                            }
                                        }
                                    }
                                }
