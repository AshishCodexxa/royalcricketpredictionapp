...
public final class AdGoogleNativeLargeBinding implements ViewBinding {
    ...
    private AdGoogleNativeLargeBinding(NativeAdView nativeAdView, TextView textView, ImageView imageView, TextView textView2, Button button, TextView textView3, MediaView mediaView, RatingBar ratingBar, RelativeLayout relativeLayout, TextView textView4) {
    ...
    public static AdGoogleNativeLargeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static AdGoogleNativeLargeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.ad_google_native_large, viewGroup, false);
        if (z) {
    ...
    public static AdGoogleNativeLargeBinding bind(View view) {
                            ...
                            if (mediaView != null) {
                                ...
                                if (ratingBar != null) {
                                    ...
                                    if (relativeLayout != null) {
                                        ...
                                        if (textView4 != null) {
                                            return new AdGoogleNativeLargeBinding((NativeAdView) view, textView, imageView, textView2, button, textView3, mediaView, ratingBar, relativeLayout, textView4);
                                        }
                                    }
                                }
                            }
